...
def wait_for_heavy_modules(request):
    ...
    if hasattr(request, "node") and hasattr(request.node, "fspath"):
        ...
        HEAVY = [
            ...
            "test_sprint244_push1650","test_sprint_t003_sla","test_tenant_isolation","test_auth_boundary","test_sprint_t005_services","test_sprint_t006_events","test_sprint_t007_readmodels",
