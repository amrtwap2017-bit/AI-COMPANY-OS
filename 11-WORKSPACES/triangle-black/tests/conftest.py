...
def wait_for_heavy_modules(request):
    ...
    if hasattr(request, "node") and hasattr(request.node, "fspath"):
        ...
        HEAVY = [
            ...
            "test_sprint244_push1650","test_sprint_t003_sla","test_tenant_isolation","test_auth_boundary","test_sprint_t005_services","test_sprint_t006_events","test_sprint_t007_readmodels","test_sprint_t009_tenancy","test_sprint_t010_ai_gateway","test_sprint_t011_digital_twin","test_sprint_t012_demo_tenant","test_sprint_t015_platform_status","test_sprint_t016_backup_restore","test_sprint_t017_coverage_push",
