...
from src.commercial.pipeline_dashboard.router import router, get_db
...
def test_list(client):
    with patch("src.commercial.pipeline_dashboard.router.PipelineRepository") as M:
