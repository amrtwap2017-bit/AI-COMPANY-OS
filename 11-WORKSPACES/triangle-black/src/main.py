...
app.include_router(activity_router,      prefix=API_PREFIX + "/activities")
app.include_router(search_router,        prefix=API_PREFIX + "/search")
app.include_router(webhook_router,       prefix=API_PREFIX)
app.include_router(quotation_router,     prefix=API_PREFIX + "/quotes")
app.include_router(auth_router,          prefix=API_PREFIX + "/auth")
app.include_router(reporting_router,     prefix=API_PREFIX + "/reports")
app.include_router(contracts_router,     prefix=API_PREFIX + "/contracts")
app.include_router(actions_router,       prefix=API_PREFIX + "/actions/commercial")
app.include_router(notifications_router, prefix=API_PREFIX + "/notifications")
app.include_router(invoices_router,      prefix=API_PREFIX + "/invoices")
app.include_router(hotels_router,        prefix=API_PREFIX + "/hotels")
app.include_router(cache_router,              prefix=API_PREFIX + "/cache")
app.include_router(pagination_router,         prefix=API_PREFIX + "/pagination")
app.include_router(email_notification_router, prefix=API_PREFIX + "/email-notifications")
