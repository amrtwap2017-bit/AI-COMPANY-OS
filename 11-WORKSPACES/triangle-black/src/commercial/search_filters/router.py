...
def search_update(leadsearch_id: str, payload: LeadSearchUpdate, db: Session = Depends(get_db)):
...
def search_delete(leadsearch_id: str, db: Session = Depends(get_db)):
