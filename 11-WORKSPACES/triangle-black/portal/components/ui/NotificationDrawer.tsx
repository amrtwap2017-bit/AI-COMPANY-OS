      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-14 right-4 w-96 bg-white rounded-2xl shadow-xl border border-border z-50 overflow-hidden"
          >
            <div className="flex items-center justify-between px-4 py-3.5 border-b border-divider">
              ...
              <div className="flex items-center gap-2">
                ...
                <button onClick={onClose} className="p-1 rounded-lg hover:bg-surface-alt transition-colors"><X className="w-4 h-4 text-secondary"/></button>
              </div>
            </div>
