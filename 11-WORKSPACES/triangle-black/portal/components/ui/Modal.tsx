...
export function Modal({
  ...
  return (
    ...
    >
      ...
      />
      <div className={"relative w-full rounded-xl shadow-lg flex flex-col max-h-[90vh] " style={{background:"var(--color-surface)",border:"1px solid var(--color-border)"}} + " " + (SIZES[size] || SIZES.md)}>
        {(title || onClose) && (
