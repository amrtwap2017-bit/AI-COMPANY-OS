        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-5 grid gap-4 md:grid-cols-2">
              {queues.map((item) => (
                <div key={item.title} className="rounded-2xl border border-stone-100 bg-slate-50 p-4">
          ...
          <div className="rounded-3xl border border-stone-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-4 space-y-3">
              {quickActions.map((item) => (
                <button
                  key={item.label}
                  className="block w-full rounded-2xl border border-stone-100 bg-slate-50 px-4 py-4 text-left transition hover:border-stone-200 hover:bg-white"
                >
