...
export function SLARiskBoard({ title, subtitle, items=[] }:any) {
  const colors:any = { warning:"bg-amber-50 border-amber-200 text-amber-700", success:"bg-emerald-50 border-emerald-200 text-emerald-700", neutral:"bg-base-alt border-border text-secondary" };
  return (
