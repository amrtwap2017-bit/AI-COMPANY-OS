...
import {
  ...
  Brain, AlertTriangle, Leaf, CheckCircle2, Layers, Truck, Radio, Server,
  CreditCard, Webhook, KeyRound, Award, Play, Cpu, Database, Gauge,
  ClipboardList, Calendar, Clock, Search, Bell, Settings, Map, GitBranch,
  ShoppingCart, Receipt, Warehouse, PieChart, Target, Star, MessageSquare,
  SlidersHorizontal, Globe, Lock, Workflow, BarChart2, TrendingDown, Eye,
  Milestone, Briefcase, UserCheck, Network, Coins, FlaskConical, Hammer,
  ScanLine, RefreshCw, ChartBar, HardDrive, MonitorCheck, Gauge as GaugeIcon
} from "lucide-react";
...
const CHILD_ICONS: Record<string, any> = {
  ...
  "sla-intelligence": CheckCircle2,
  "financial-intelligence": TrendingDown,
