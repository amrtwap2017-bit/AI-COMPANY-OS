...
const toneMap = {
  ...
  neutral: { card: "border-border bg-base-alt",     value: "text-primary",   icon: Activity, iconColor: "text-tertiary" },
};
          ...
          return (
            <div key={item.label} className={`rounded-xl border p-4 ${t.card}`}>
              <div className="flex items-center justify-between mb-2">
                <span className="text-[11px] font-semibold uppercase tracking-widest text-secondary">{item.label}</span>
