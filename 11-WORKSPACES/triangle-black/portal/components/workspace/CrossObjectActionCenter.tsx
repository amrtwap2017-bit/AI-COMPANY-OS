    ...
    <div className="bg-white rounded-2xl border border-stone-200 p-5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
        {actions.slice(0,6).map((a:any,i:number)=>(
          <button key={i} className="p-3 rounded-xl border border-stone-200 hover:border-amber-300 hover:bg-amber-50 transition-all text-left">
            <p className="text-sm font-semibold text-stone-800">{a.title||a.label||"Action"}</p>
