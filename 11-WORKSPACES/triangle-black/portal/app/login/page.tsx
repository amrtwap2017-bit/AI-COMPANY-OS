    ...
    <div style={{
      ...
      <div style={{width:"100%",maxWidth:420,padding:"0 20px",position:"relative",zIndex:1}}>
        ...
        <div style={{textAlign:"center",marginBottom:40}}>
          ...
          <p style={{fontSize:"0.8125rem",color:"#6D5F53",marginTop:6}}>Engineering Operations Platform</p>
        </div>
        ...
        <div style={{
          ...
          <form onSubmit={handleLogin}>
            ...
            <div style={{marginBottom:24}}>
              <label style={{display:"block",fontSize:"0.75rem",color:"#B29F8B",marginBottom:6,textTransform:"uppercase",letterSpacing:"0.06em",fontWeight:600}}>Password</label>
              <input
                type="password"
                value={password}
