...
export default function TechniciansPage() {
  ...
  const { data: raw, isLoading } = useQuery(
    ["tech-list"],()=>authFetch("/api/v1/technicians/").then(r => (r as any).data ?? r),{refetchInterval:60000}
  );
  const { data: woRaw } = useQuery(["tech-wos"],()=>authFetch("/api/v1/work-orders/").then(r => (r as any).data ?? r));
