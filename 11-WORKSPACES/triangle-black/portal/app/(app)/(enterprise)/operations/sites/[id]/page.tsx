  ...
  return (
    <div className="min-h-screen bg-base">
      ...
      <div className="tb-canvas">
        ...
        {siteAssets.length>0&&(
          <div className="tb-section">
            <div className="tb-section-header"><div className="tb-section-title" className="mb-0">Assets ({siteAssets.length})</div><button onClick={()=>router.push("/maintenance/assets")} className="tb-section-link">All →</button></div>
