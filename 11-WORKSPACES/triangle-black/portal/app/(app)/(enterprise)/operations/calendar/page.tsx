...
export default function Page() {
  ...
  const columns = [
    ...
    { key:"due_date", label:"Due Date", render:(r:any)=>(<span className="text-sm text-slate-700">{String(r["due_date"]??"—")}</span>) },
  ];

  return (
    <PageWrapper>
      <Breadcrumb/>
      <PageHeader title="Operations Calendar" subtitle={`${items.length} records`} badge="CAL"
