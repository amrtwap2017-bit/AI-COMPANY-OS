...
export default function SLADashboardPage() {
  ...
  const { data: sla, isLoading } = useQuery(["sla-dashboard"],()=>authFetch("/api/v1/sla/dashboard").then(r => (r as any).data ?? r),{staleTime:30000,refetchInterval:60000});
  const { data: breaches=[] } = useQuery(["sla-breaches"],()=>authFetch("/api/v1/sla/breaches").then(r => (r as any).data ?? r),{staleTime:30000});
