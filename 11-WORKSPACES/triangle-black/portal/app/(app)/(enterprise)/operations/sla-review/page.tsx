...
export default function SLAReviewPage() {
  ...
  const { data: sla, isLoading } = useQuery({ queryKey:["sla-dashboard"], queryFn:()=>authFetch("/api/v1/sla/dashboard").then(r => (r as any).data ?? r), staleTime:60000, refetchInterval:120000 });
