...
export default function ApprovalsPage() {
  ...
  const { data: raw, isLoading } = useQuery(["approvals-all"], ()=>authFetch("/api/v1/approval-requests/").then(r => (r as any).data ?? r), {staleTime:20000});
  ...
  const approve = useMutation({
    mutationFn: (id)=>authFetch(`/api/v1/approval-requests/${id}/approve`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({approved_by:"amr@triangleblack.com"})}).then(r => (r as any).data ?? r),
