...
export default function CustomerDetailPage() {
  ...
  const { data: ctRaw, isLoading } = useQuery(["cust-d-cts"], () => authFetch("/api/v1/contracts/").then(r => (r as any).data ?? r));
  const { data: invRaw } = useQuery(["cust-d-inv"], () => authFetch("/api/v1/invoices/").then(r => (r as any).data ?? r));
