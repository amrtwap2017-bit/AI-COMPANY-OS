...
export default function CustomerSuccessPage() {
  ...
  const { data: slaDash }   = useQuery(["cs-sla"],       ()=>authFetch("/api/v1/sla/dashboard").then(r => (r as any).data ?? r),    {staleTime:60000});
  const { data: contracts } = useQuery(["cs-contracts"], ()=>authFetch("/api/v1/contracts/").then(r => (r as any).data ?? r),       {staleTime:60000});
