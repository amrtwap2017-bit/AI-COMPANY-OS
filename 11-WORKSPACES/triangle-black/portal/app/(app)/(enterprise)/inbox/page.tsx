...
export default function Page() {
  ...
  const columns = [
    { key:"title", label:"Message", render:(r:any)=>(<span className="text-sm text-slate-700">{String(r["title"]??"—")}</span>) },
  ...
  return (
    <PageWrapper>
      <Breadcrumb/>
      <PageHeader title="Inbox" subtitle={`${items.length} records`} badge="INBOX"
