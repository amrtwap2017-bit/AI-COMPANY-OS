...
export default function Page() {
  ...
  const columns = [
    { key:"title", label:"Alert", render:(r:any)=>(<span className="text-sm text-slate-700">{String(r["title"]??"—")}</span>) },
  ...
  return (
    <PageWrapper>
      <Breadcrumb/>
      <PageHeader title="System Alerts" subtitle={`${items.length} records`} badge="ALERT"
