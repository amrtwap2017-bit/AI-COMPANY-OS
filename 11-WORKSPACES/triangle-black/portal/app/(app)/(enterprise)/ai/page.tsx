...
export default function AIAssistantPage() {
  ...
  const summary = (knowledgeQ.data as any)?.data_summary||{};
      ...
      <Breadcrumb/>
        ...
        {tab==="recommendations"&&(
          <div className="flex-1 overflow-y-auto p-6 space-y-4 bg-slate-50">
            ...
            {!recsQ.isLoading&&((recsQ.data as any)?.recommendations||[]).length===0&&(
            ...
            {((recsQ.data as any)?.recommendations||[]).map((rec:any)=>(
