...
export default function FinancialDashboardPage() {
  ...
  const { data: fin, isLoading } = useQuery(["financial-dashboard"],()=>authFetch("/api/v1/financial/dashboard").then(r => (r as any).data ?? r),{staleTime:60000});
  const { data: cashFlow }       = useQuery(["cash-flow"],           ()=>authFetch("/api/v1/financial/cash-flow").then(r => (r as any).data ?? r),{staleTime:60000});
