...
export default function ListPage() {
  ...
  return (
    <PageWrapper>
      <PageHeader
        title="List"
        subtitle={`${items.length} projects records`}
        breadcrumbs={[{label:"Projects Center",href:"/projects-center"},{label:"List"}]}
      />
      ...
      <SectionCard title={`Projects (${filtered.length})`}>
        <div className="flex flex-wrap items-center gap-2 mb-4 pb-4 border-b border-slate-100">
          <input type="text" placeholder="Search list…" value={q}
        ...
        {isLoading?<LoadingState/>:filtered.length===0?<EmptyState title="No projects found" subtitle="Adjust filters or check your data"/>:(
