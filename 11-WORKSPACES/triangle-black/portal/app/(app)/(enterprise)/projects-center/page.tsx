...
export default function Page() {
  ...
  const columns = [
    ...
    { key:"end_date", label:"Due", render:(r:any)=>(<span className="text-sm text-slate-700">{String(r["end_date"]??"—")}</span>) },
  ];
  return (
    <PageWrapper>
      <Breadcrumb/>
      <PageHeader title="Projects Center" subtitle={`${items.length} records`} badge="PRJ"
