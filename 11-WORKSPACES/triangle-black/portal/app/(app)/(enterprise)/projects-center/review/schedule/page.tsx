  ...
  return (
    <PageWrapper>
      <PageHeader
        ...
        subtitle="Project signals and alerts"
        badge="REVIEW"
      />
      <SectionCard title="Quick Navigation">
        ...
        <a href="/projects-center/actions"
          className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-200 hover:border-amber-300 hover:shadow-sm transition-all group">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-900 mb-2">Project Review</h3>
        <p className="text-sm text-slate-500 max-w-md mx-auto">Project signals and alerts. This section is being built and will show live data soon.</p>
      </div>
    </PageWrapper>
  );
}
