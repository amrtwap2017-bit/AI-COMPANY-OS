...
export default function PaymentHistoryPage() {
  ...
  const { data: dash }   = useQuery(["pay-dash"], ()=>authFetch("/api/v1/financial/dashboard").then(r => (r as any).data ?? r), {staleTime:60000});
  const { data: invRaw } = useQuery(["pay-inv"],  ()=>authFetch("/api/v1/supplier-invoices/").then(r => (r as any).data ?? r), {staleTime:30000});
