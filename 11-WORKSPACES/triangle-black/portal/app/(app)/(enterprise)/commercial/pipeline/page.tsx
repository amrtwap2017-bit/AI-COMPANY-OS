...
export default function PipelinePage() {
  ...
  const { data: leadRaw } = useQuery(["pl-leads"], () => authFetch("/api/v1/leads/?limit=100").then(r => (r as any).data ?? r));
  const { data: contRaw } = useQuery(["pl-conts"], () => authFetch("/api/v1/contracts/").then(r => (r as any).data ?? r));
