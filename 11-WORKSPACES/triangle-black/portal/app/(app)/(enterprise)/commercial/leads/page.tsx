...
function LeadsPageInner() {
  ...
  const { data: raw, isLoading } = useQuery(["leads-list"],()=>authFetch("/api/v1/leads-portal-v2").then(r => (r as any).data ?? r));
    ...
    <div className="min-h-screen bg-base">
      ...
      <div className="tb-canvas">
        ...
        <div className="flex gap-2.5 flex-wrap items-center mb-4">
          <input value={search} onChange={(e: any) =>setSearch(e.target.value)} placeholder="Search leads by name or company..."
