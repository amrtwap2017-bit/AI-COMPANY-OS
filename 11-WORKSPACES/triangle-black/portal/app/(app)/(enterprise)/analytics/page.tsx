...
export default function AnalyticsHub() {
  ...
  const kpiGroups = [
    {section:"Operations",  color:"#F97316", path:"/operations",  kpis:[
    ...
    {section:"Maintenance", color:"#EF4444", path:"/maintenance",kpis:[
    ...
    {section:"Finance",     color:"#10B981", path:"/invoices",  kpis:[
    ...
    {section:"Commercial",  color:"#8B5CF6", path:"/commercial",kpis:[
          ...
          <div className="tb-grid-4 mt-6">
            {subPages.map((s,i)=>(
              <button key={i} onClick={()=>router.push(s.path)}
                ...
                <div className="text-sm font-bold" style={{color:"#F1F5F9",marginBottom:3}}>{s.title}</div>
