...
export default function AnalyticsSLA() {
  ...
  const { data: woRaw } = useQuery(["sla-wos"],()=>authFetch("/api/v1/work-orders/").then(r => r.data ?? r));
  const { data: slaDash } = useQuery(["sla-dash"],()=>authFetch("/api/v1/sla/dashboard").then(r => r.data ?? r),{staleTime:60000});
