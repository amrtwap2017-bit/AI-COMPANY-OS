...
export default function TasksPage() {
  ...
  const { data: srRaw, isLoading } = useQuery(["tasks-srs"], () => authFetch("/api/v1/service-requests/").then(r => (r as any).data ?? r),{refetchInterval:30000});
  const { data: woRaw } = useQuery(["tasks-wos"], () => authFetch("/api/v1/work-orders/").then(r => (r as any).data ?? r));
