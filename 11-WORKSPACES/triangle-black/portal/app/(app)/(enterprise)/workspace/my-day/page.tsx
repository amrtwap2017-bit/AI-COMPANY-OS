...
export default function Page() {
  ...
  const columns = [
    { key:"title", label:"Task", render:(r:any)=>(<span className="text-sm text-slate-700">{String(r["title"]??"—")}</span>) },
  ...
  return (
    <PageWrapper>
      <Breadcrumb/>
      <PageHeader title="My Day" subtitle={`${items.length} records`} badge="TODAY"
