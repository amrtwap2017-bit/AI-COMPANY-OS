...
// ── Fetch helpers ─────────────────────────────────────────────────────────────
const fetchMyDay    = () => authFetch("/api/v1/workspace/my-day").then(r => (r as any).data ?? r);
const fetchApprovals = () => authFetch("/api/v1/approval-requests/").then(r => (r as any).data ?? r);
const fetchSLA      = () => authFetch("/api/v1/sla/breaches").then(r => (r as any).data ?? r);
const fetchWOs      = () => authFetch("/api/v1/work-orders/?limit=10&status=open").then(r => (r as any).data ?? r);
