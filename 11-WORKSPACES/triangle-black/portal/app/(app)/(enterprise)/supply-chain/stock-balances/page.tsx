  ...
  return (
    <div className="min-h-screen bg-base">
          ...
          <div className="tb-grid-4 mt-6">
            {isLoading ? <KpiSkeleton /> : <>
              ...
              <div className="tb-hero-kpi" onClick={() => { setFilterStatus("low"); setPage(1); }} style={{cursor:"pointer"}}>
                <div className="tb-hero-kpi-value" style={{color:"var(--color-warning)"}}>{lowStock}</div>
              ...
              <div className="tb-hero-kpi" onClick={() => { setFilterStatus("critical"); setPage(1); }} style={{cursor:"pointer"}}>
                <div className="tb-hero-kpi-value" style={{color:"var(--color-danger)"}}>{critical}</div>
      ...
      <div className="tb-canvas">
        ...
        {/* Filter Bar */}
        <div className="tb-section" style={{padding:"14px 18px"}}>
          <div className="flex gap-2.5 flex-wrap items-center">
            ...
            <div className="flex gap-1.5">
              {["all","ok","low","critical"].map(s => (
                <button key={s} onClick={() => { setFilterStatus(s); setPage(1); }}
                  className={`tb-btn tb-btn-sm ${filterStatus === s ? (s === "ok" ? "tb-btn-primary" : s === "low" ? "" : s === "critical" ? "tb-btn-danger" : "tb-btn-secondary") : "tb-btn-ghost"}`}>
            ...
            {hasFilters && (
              <button onClick={clearFilters} className="tb-btn tb-btn-ghost tb-btn-sm">✕ Clear</button>
            )}
                ...
                <table className="tb-table">
                  ...
                  <tbody>
                    {paged.map((b, i) => {
                      ...
                      return (
                        <tr key={b.id || i} className={isCritical ? "bg-danger/4" : isLow ? "bg-warning/4" : ""}>
                          <td>
                          ...
                          <td className="text-right">
                            <span className="text-sm font-semibold text-success">{fmtQty(b.qty_available, b.unit)}</span>
                          </td>
