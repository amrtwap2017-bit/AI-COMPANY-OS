...
export default function VendorManagementPage() {
  ...
  const createVendor = useMutation(
    (payload)=>authFetch("/api/v1/vendors/",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(payload)}).then(r => (r as any).data ?? r),
  ...
  const { data: raw, isLoading } = useQuery(["vendors-list"], ()=>authFetch("/api/v1/vendors/").then(r => (r as any).data ?? r), {staleTime:60000});
