      ...
      <div className="tb-hero" >
        <div className="tb-hero-inner">
          ...
          <div className="tb-grid-4 mt-6">
            {[{label:"Total",value:grs.length,color:"#221D1A"},{label:"This Month",value:grs.filter(g=>g.created_at&&new Date(g.created_at)>new Date(Date.now()-30*86400000)).length,color:"#547C4D"}].map((k,i)=>(
