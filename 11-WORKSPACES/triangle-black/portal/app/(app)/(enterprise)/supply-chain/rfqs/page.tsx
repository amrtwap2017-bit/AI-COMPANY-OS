...
export default function Page() {
  ...
  const columns = [
    ...
    { key:"supplier_count", label:"Suppliers", render:(r:any)=>(<span className="text-sm text-slate-700">{String(r["supplier_count"]??"—")}</span>) },
  ...
  return (
    <PageWrapper>
      <Breadcrumb/>
      <PageHeader title="RFQs" subtitle={`${items.length} records`} badge="RFQ"
