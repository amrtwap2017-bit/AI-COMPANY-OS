...
export default function HotelsPage() {
  ...
  const { data: siteRaw, isLoading } = useQuery(["hotels-sites"], () => authFetch("/api/v1/sites-portal").then(r => (r as any).data ?? r));
  const { data: assetRaw } = useQuery(["hotels-assets"], () => authFetch("/api/v1/assets/").then(r => (r as any).data ?? r));
