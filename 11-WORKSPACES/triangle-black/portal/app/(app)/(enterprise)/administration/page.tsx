...
export default function AdministrationPage() {
  ...
  const metrics = [
    { label:"Users", value:usersQ.data?.length||usersQ.data?.count||"—", icon:<Users className="w-4 h-4"/>, color:"blue" },
    { label:"Hotels", value:hotelsQ.data?.length||hotelsQ.data?.count||1, icon:<Hotel className="w-4 h-4"/>, color:"amber" },
