    ...
    <div className="p-6 space-y-6 bg-slate-50 dark:bg-slate-950 min-h-screen">
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-3xl font-black text-slate-900 dark:text-white">Actionable Insights</h1>
          <p className="text-slate-500 mt-1">Data-driven recommendations from live platform analysis</p>
        </div>
        <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 px-6 py-4 text-center">
          ...
          <div className="text-xs text-slate-500">Actions Needed</div>
        </div>
      </div>
            ...
            <div key={rec.id} className={`${cfg.bg} border ${cfg.border} rounded-2xl p-6`}>
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  <h3 className="text-xl font-black text-slate-900 dark:text-white mb-2">{rec.title}</h3>
                  <div className="text-sm text-slate-600 dark:text-slate-400 mb-2"><span className="font-semibold">Impact:</span> {rec.impact}</div>
                  <div className="text-sm text-slate-700 dark:text-slate-300 mb-2"><span className="font-semibold">Action:</span> {rec.action}</div>
                  <div className="text-sm text-slate-500"><span className="font-semibold">Data:</span> {rec.metric} · <span className="font-semibold">Effort:</span> {rec.effort}</div>
                </div>
