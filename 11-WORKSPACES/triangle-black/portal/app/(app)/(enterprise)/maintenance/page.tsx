      ...
      <div className="tb-hero" style={{background:"linear-gradient(135deg, #221D1A 0%, #0E1A1A 100%)"}}>
        <div className="tb-hero-inner">
          ...
          <div className="tb-grid-4 mt-6">
            {[{label:"Total Assets",value:assets.length,color:"#221D1A"},{label:"In Fault",value:faulted,color:faulted>0?"#A84A3D":"#547C4D"},{label:"Overdue PMs",value:overduePMs,color:overduePMs>0?"#B07A2A":"#547C4D"},{label:"Active WOs",value:activeWOs,color:activeWOs>0?"#5B7C8C":"#547C4D"}].map((k,i)=>(
