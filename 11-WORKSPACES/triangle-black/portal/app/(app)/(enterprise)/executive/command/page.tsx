...
export default function CommandPage() {
  ...
  const { data: twin } = useQuery(["cmd-twin"], () => authFetch("/api/v1/twin/state").then(r => (r as any).data ?? r));
  const { data: dash } = useQuery(["cmd-dash"], () => authFetch("/api/v1/dashboard/summary").then(r => (r as any).data ?? r),{refetchInterval:30000});
