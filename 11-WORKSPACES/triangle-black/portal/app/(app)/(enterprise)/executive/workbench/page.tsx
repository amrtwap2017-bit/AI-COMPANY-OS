...
export default function Page() {
  ...
  const columns = [
    { key:"topic", label:"Topic", render:(r:any)=>(<span className="text-sm text-slate-700">{String(r["topic"]??"—")}</span>) },
  ...
  return (
    <PageWrapper>
      <Breadcrumb/>
      <PageHeader title="Executive Workbench" subtitle={`${items.length} records`} badge="WB"
