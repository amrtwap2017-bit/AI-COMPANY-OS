...
export default function SettingsPage() {
  ...
  const { data: me } = useQuery(["settings-me"], () => authFetch("/api/v1/auth/me").then(r => (r as any).data ?? r));
  const { data: twin } = useQuery(["settings-twin"], () => authFetch("/api/v1/twin/state").then(r => (r as any).data ?? r));
