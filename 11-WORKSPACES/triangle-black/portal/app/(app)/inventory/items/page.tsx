  ...
  return (
    <PageWrapper>
      <PageHeader
        ...
        subtitle="Inventory Items management"
        badge="INVE"
      />
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
        ...
        <p className="text-sm text-slate-500 max-w-md mx-auto">Inventory Items management. This section is being built and will show live data soon.</p>
      </div>
    </PageWrapper>
  );
}
