...
export default function WarehousesPage() {
  ...
  const { data: whRaw, isLoading } = useQuery(["wh-list"], () => authFetch("/api/v1/warehouses-portal").then(r => r.data ?? r));
  const { data: stockRaw } = useQuery(["wh-stock"], () => authFetch("/api/v1/stock-balances/").then(r => r.data ?? r));
