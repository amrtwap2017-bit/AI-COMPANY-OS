...
export default function WarehousesPage() {
  ...
  const { data: whRaw, isLoading } = useQuery(["wh-list"], () => authFetch("/api/v1/warehouses-portal").then(r => (r as any).data ?? r));
  const { data: stockRaw } = useQuery(["wh-stock"], () => authFetch("/api/v1/stock-balances/").then(r => (r as any).data ?? r));
        ...
        <div className="tb-hero-inner">
          ...
          <div className="tb-grid-4 mt-6">
            {[
              ...
              { label:"Active",         value:whs.filter((w: any) =>w.status==="active"||!w.status).length, color:"#60A5FA" },
      ...
      <div className="tb-canvas">
        ...
        <div className="tb-section">
          ...
          <div className="tb-grid-3">
            {[{label:"Inventory",icon:"📦",path:"/supply-chain/inventory"},{label:"Purchase Orders",icon:"📦",path:"/supply-chain/purchase-orders"},{label:"Goods Receipts",icon:"✅",path:"/supply-chain/goods-receipts"}].map((a: any, i: number) =>(
