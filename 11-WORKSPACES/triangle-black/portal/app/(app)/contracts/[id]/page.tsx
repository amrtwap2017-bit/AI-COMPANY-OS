...
export default function Page() {
  ...
  const columns = [
    { key:"contract_number", label:"Number", render:(r:any)=>(<span className="text-sm text-slate-700">{String(r["contract_number"]??"—")}</span>) },
  ...
  return (
    <PageWrapper>
      <Breadcrumb/>
      <PageHeader title="Contract Detail" subtitle={`${items.length} records`} badge="CTR"
