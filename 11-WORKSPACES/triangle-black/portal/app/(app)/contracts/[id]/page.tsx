...
export default function Page() {
  return (
    <PageWrapper>
      <PageHeader
        title="Contracts Id"
        subtitle="Contracts Id management"
        badge="CONT"
      />
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-900 mb-2">Contracts Id</h3>
        <p className="text-sm text-slate-500 max-w-md mx-auto">Contracts Id management. This section is being built and will show live data soon.</p>
      </div>
    </PageWrapper>
  );
}
