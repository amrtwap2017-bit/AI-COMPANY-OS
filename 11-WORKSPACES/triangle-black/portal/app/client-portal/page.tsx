...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const res = await fetch("/api/v1/client/login",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email,pin})});
    ...
    <div className="min-h-screen flex items-center justify-center relative"
      ...
      <div className="w-full max-w-md px-5 relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-sm mt-1.5" style={{color:"#6D5F53"}}>Hotel Client Access</p>
        </div>
        ...
        <div className="rounded-2xl px-7 py-8" style={{background:"#2D2723",border:"1px solid #3D352F",boxShadow:"0 20px 40px rgba(0,0,0,0.35)"}}>
          <h2 className="text-lg font-bold mb-1" className="text-primary">Client Portal</h2>
