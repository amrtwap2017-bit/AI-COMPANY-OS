...
const FIELDS = [
        ...
        { label: "Max Jobs", key: "max_work_orders" },
        { label: "Current Jobs", key: "current_work_orders" },
];
...
export default function DetailPage() {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey:  ["-api-v1-technicians", id],
  ...
  if (isError || !data) {
    return (
      <PageWrapper>
        ...
        <Link href="/technicians" className="flex items-center gap-2 text-sm text-amber-600 mt-4">
