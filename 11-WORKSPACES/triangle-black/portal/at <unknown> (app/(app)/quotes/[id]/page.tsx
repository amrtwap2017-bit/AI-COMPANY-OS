...
export default function Page() {
  return (
    <PageWrapper>
      <PageHeader
        title="At <Unknown> (Quotes Id"
        subtitle="At <Unknown> (Quotes Id management"
        badge="AT"
      />
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-900 mb-2">At <Unknown> (Quotes Id</h3>
        <p className="text-sm text-slate-500 max-w-md mx-auto">At <Unknown> (Quotes Id management. This section is being built and will show live data soon.</p>
      </div>
    </PageWrapper>
  );
}
