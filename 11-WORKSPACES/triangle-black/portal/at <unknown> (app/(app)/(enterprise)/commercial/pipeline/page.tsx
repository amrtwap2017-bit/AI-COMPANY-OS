  ...
  return (
    <PageWrapper>
      <PageHeader
        ...
        subtitle="Visual pipeline overview"
        badge="PIPE"
      />
      <SectionCard title="Quick Navigation">
        ...
        <a href="/quotes"
          className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-200 hover:border-amber-300 hover:shadow-sm transition-all group">
          <span className="text-sm font-semibold text-slate-900 group-hover:text-amber-700">Quotes</span>
          <span className="text-slate-300 group-hover:text-amber-500 text-lg">›</span>
        </a>
        </div>
      </SectionCard>
      <div className="bg-white rounded-2xl border border-slate-200 p-8 text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-900 mb-2">Sales Pipeline</h3>
        <p className="text-sm text-slate-500 max-w-md mx-auto">Visual pipeline overview. This section is being built and will show live data soon.</p>
      </div>
    </PageWrapper>
  );
}
