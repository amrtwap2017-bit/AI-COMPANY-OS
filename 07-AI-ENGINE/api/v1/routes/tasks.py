...
def submit_dag(req: DAGTaskRequest) -> dict:
    ...
    """
    from tasks.handlers import run_dag_task
...
def submit_collaboration(req: CollaborationTaskRequest) -> dict:
    ...
    """
    from tasks.handlers import run_collaboration_task
...
def submit_workflow(req: WorkflowTaskRequest) -> dict:
    ...
    from tasks.handlers import run_workflow_task
...
def submit_learning() -> dict:
    ...
    from tasks.handlers import run_learning_task
...
def submit_news_ingest(req: NewsIngestTaskRequest) -> dict:
    ...
    from tasks.handlers import run_news_ingest_task
