...
from app.knowledge.parsers.docx_parser  import docx_parser
from app.knowledge.parsers.xlsx_parser  import xlsx_parser
from app.knowledge.parsers.image_parser import image_parser
