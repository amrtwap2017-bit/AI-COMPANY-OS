...
from app.evaluation.benchmarks import Benchmark, get_benchmarks, get_benchmark
from app.evaluation.scorer import BenchmarkScorer
...
class BenchmarkRunner:
    ...
    def _llm_score(self, prompt: str, output: str) -> dict | None:
        ...
        try:
            from app.evaluation.evaluator import evaluator_agent
